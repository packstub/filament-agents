...
- **Docs.** The README and the docs index link the [60-second demo](https://youtu.be/-O5P8rHw4S4) on YouTube. The installation page shows the OpenRouter key next to the other providers, and the configuration page pins three OpenRouter models (Mercury 2.5, GLM 5.3 Flash, DeepSeek 4.1 Flash) as the example of a provider without entries of its own.
